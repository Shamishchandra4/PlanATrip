...
const LandingPage = () => {
  return (
    <div>
      ...
      <div className="bg-cover bg-center min-h-screen flex flex-col justify-between text-white" style={{ backgroundImage: "url('https://ecotourism-world.com/wp-content/uploads/2022/04/pietro-de-grandi-T7K4aEPoGGk-unsplash.jpeg')" }}>
        {/* Navbar */}
        ...
        <div className="flex-grow flex flex-col justify-center items-center px-6 text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-4  poppins-semibold">TAKE A TRIP</h1>
          ...
          <a href="#" className="bg-black text-white py-3 px-8 rounded-lg hover:bg-gray-800 transition">
            Join Us →
          </a>
        </div>
        ...
        <footer className="p-4 text-center text-sm text-gray-400">
          © 2024 Take A Trip. All Rights Reserved.
        </footer>
      </div>
